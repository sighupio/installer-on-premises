<<<<<<<< HEAD:docs/releases/v1.33.4-rev.2.md
# On Premises module release v1.33.4-rev.2
========
# On Premises module release v1.34.2
>>>>>>>> cadf7f3 (docs: update release notes,comp. matrix):docs/releases/v1.34.2.md
...
- [[#163](https://github.com/sighupio/installer-on-premises/pull/163)] **Add PKI directory and CAs initialization in etcd and control-plane roles**: this change allows local PKI files to be copied to remote etcd and control plane hosts.
