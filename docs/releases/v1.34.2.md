...
This release installs Kubernetes version 1.34.2, adds support for Kubernetes v1.33.6, v1.32.10 and updates `runc` (among other components) in order to cover the [CVE-2025-31133](https://nvd.nist.gov/vuln/detail/CVE-2025-31133)
