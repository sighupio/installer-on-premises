...
![Release](https://img.shields.io/badge/Latest%20Release-v1.36.4-blue)
...
| ---------------------------------------------- |----------| ----------------------------------------------------------------------------- |
| [etcd](roles/etcd)                             | `3.6.14` | Ansible role to install etcd as systemd service                               |
| [haproxy](roles/haproxy)                       | `3.0`    | Ansible role to install HAProxy as Kubernetes load balancer for the APIServer |
| [containerd](roles/containerd)                 | `2.3.6`  | Ansible role to install containerd as container runtime                       |
...
This version is compatible with Kubernetes 1.36.4 plus the complete list in the compatibility matrix.
...
[compatibility-matrix]: https://github.com/sighupio/installer-on-premises/blob/main/docs/COMPATIBILITY_MATRIX.md
